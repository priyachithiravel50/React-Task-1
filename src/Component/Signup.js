        ...
        <Paper elevation={10} style={{ padding: '30px', borderRadius: '30px', maxWidth: '1100px', width: '100%', backgroundColor: '#e2edff',height:'700px' }}>
          <Box display="flex" justifyContent="space-between" alignItems="center">
            <Box width="50%">
              ...
              <Typography variant="body2" fontFamily={'Georgia'}>Already have an account? <Link href="/signin" onClick={() => this.handleSignup()}>Login here</Link>
              </Typography>
              ...
              <form onSubmit={this.handleSubmit} style={{ marginTop: '20px', borderRadius: '25px', fontFamily:'Georgia' }}>
                ...
                {/* <TextField fullWidth label="Address" name="address" value={this.state.address} onChange={this.handleChange} margin="normal" required multiline rows={2}/> */}
                {/* Dropdown for Role */}
                <TextField
                  select
                  label="Role"
